...
\title{COMP47650 Deep Learning Project}
...
\begin{abstract}
  The porco io abstract paragraph should be indented \nicefrac{1}{2}~inch (3~picas) on
...
nonymized version of your work with the text ``Preprint. Work in progress.''
